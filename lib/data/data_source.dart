    ...
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(
          ...
          children: [
            Image.asset("assets/images/extra.jpeg"),
            Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(dessert.name, style: TextStyle(color: secondaryColor, fontSize: 16.0, fontWeight: FontWeight.bold),),
                SizedBox(height: 5.0,),
                Text("Painkiller", style: TextStyle(color: Colors.grey),),
              ],
            )
          ],
        ),),
