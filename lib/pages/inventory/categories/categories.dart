...
class _CategoriesPageState extends State<CategoriesPage> {
  ...
  Future<Null> getResults() async {
    ...
    final responseData = await http.get(
      Uri.parse("https://serow.herrings.co.ke/api/v1/inventory/categories/"),
      headers: {
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: CustomText(
                      text: "You have a total of 2 categories.", //ToDo: Read from count method
                      size: 12,
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Flexible(
                                                              child: TextField(
                                                                ...
                                                                InputDecoration(
                                                                  //  labelText: "Email Address",
                                                                    errorText: _validate ? 'Subgroup Can\'t Be Empty' : null,
                                                                    hintText:
                                                                    "Subgroup",
                                                                    hintStyle: TextStyle(
                                                                        fontSize:
