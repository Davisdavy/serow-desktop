...
class _GroupsPageState extends State<GroupsPage> {
  ...
  Future<Brands> createBrands(String name,String shortName, String country) async{
    final response = await http.post(
      Uri.parse("https://serow.herrings.co.ke/api/v1/inventory/groups/"),
      headers: {
        'Content-type': 'application/json',
        'Accept': 'application/json',
        "Authorization":
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: CustomText(
                      text: "You have a total of 5 groups.", //ToDo: Read from count method
                      size: 12,
                                                              ...
                                                              child: TextField(
                                                                ...
                                                                InputDecoration(
                                                                  //  labelText: "Email Address",
                                                                    errorText: _validate ? 'Group Name Can\'t Be Empty' : null,
                                                                    hintText:
                                                                    "Group Name",
                                                                    hintStyle: TextStyle(
                                                                        fontSize:
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Flexible(
                                                              child: TextField(
                                                                ...
                                                                InputDecoration(
                                                                  //  labelText: "Email Address",
                                                                    errorText: _validate ? 'Priority Can\'t Be Empty' : null,
                                                                    hintText:
                                                                    "Priority",
                                                                    hintStyle: TextStyle(
                                                                        fontSize:
