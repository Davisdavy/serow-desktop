...
class StrengthsPage extends StatefulWidget {
  const StrengthsPage({Key key}) : super(key: key);
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: CustomText(
                                      text: "You have a total of 5 strengths.",
                                                          ...
                                                          children: [
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Material(
                                                                  child: CustomText(
                                                                    text:
                                                                    "Enter details to create strength.",
                                                                    size: 11.0,
                                                                    color: Colors.blueGrey,
                                                                    weight: FontWeight.w500,
                                                                  )),
