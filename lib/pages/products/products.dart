                      ...
                      child: Container(height: 40.0,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.0,),
                            Text("Add Product", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400),)
                          ],
                        ),
                          ),
                    )
            ...
            child: ListView(
              ...
              children: [
                PaginatedDataTable(
                  rowsPerPage: 1,
                  columns: [
                    DataColumn(label: Text('Products', style: TextStyle(color: Colors.blueGrey, fontSize: 14),)),
                    DataColumn(label: Text('Supplier', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
                    DataColumn(label: Text('Inventory', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
                    DataColumn(label: Text('Price', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
                    DataColumn(label: Text('Sales', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
