            ...
            child: Row(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(left:60.0,),
                  child: CustomText(
                    text: "You have a total of 567 suppliers.",
                    size: 12,
                      ...
                      child: Container(height: 40.0,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.0,),
                            Text("Add Suppliers", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400),)
                          ],
                        ),
                      ),
                    )
            ...
            child: ListView(
              ...
              children: [
                PaginatedDataTable(
                  rowsPerPage: 1,
                  columns: [
                    DataColumn(label: Text('Suppliers', style: TextStyle(color: Colors.blueGrey, fontSize: 14),)),
                    DataColumn(label: Text('Contact', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
                    DataColumn(label: Text('Products', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
                    DataColumn(label: Text('Amount Owed', style: TextStyle(color: Colors.blueGrey, fontSize: 14))),
