...
class GoodsReceivedNotesDataSource extends  DataTableSource{
  //Dependency injection
  var  goodsReceivedNotesController = GoodsReceivedNotesController(GoodsReceivedNotesSupplierRepository());
  GoodsReceivedNotesDataSource({
            ...
            Builder(
                builder: (newContext) {
                  return FutureBuilder<List<Results>>(
                    future: goodsReceivedNotesController.fetchGoodsReceivedNote(newContext),
                        ...
                        itemBuilder: (context) =>[
                          ...
                          PopupMenuItem(
                            onTap: ()  {
                              ...
                              goodsReceivedNotesController.deleteGoodsReceivedNote(_result.id.toString(), newContext);
                            },
                            child:Row(
                              children: [
