...
class GroupsDataSource extends  DataTableSource{
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: <DataCell>[
        ...
        DataCell(Text('${_result.priority}',style: TextStyle(fontSize: 13.0, color: secondaryColor))),
            ...
            Builder(
              builder: (newContext) {
                return FutureBuilder<List<Results>>(
                  future: groupsController.fetchGroupsList(newContext),
                      ...
                      itemBuilder: (context) =>[
                        ...
                        PopupMenuItem(
                          onTap: ()  {
                            ...
                            groupsController.deleteGroup(_result.id.toString(), context);
                          },
                          child:Row(
                            children: [
