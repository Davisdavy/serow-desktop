            ...
            Builder(
                builder: (newContext) {
                  return FutureBuilder<List<Results>>(
                    future: postingCategoriesController.fetchPostingCategoryList(newContext),
                        ...
                        itemBuilder: (context) =>[
                          ...
                          PopupMenuItem(
                            onTap: ()  {
                              ...
                              postingCategoriesController.deletePostingCategory(_result.id.toString(), newContext);
                            },
                            child:Row(
                              children: [
