...
class StrengthsDataSource extends  DataTableSource{
  //Dependency injection
  var strengthsController = StrengthsController(StrengthInventoryRepository());
  StrengthsDataSource({
            ...
            Builder(
              builder: (newContext) {
                return FutureBuilder<List<Results>>(
                  future: strengthsController.fetchStrengthsList(newContext),
                      ...
                      itemBuilder: (context) =>[
                        ...
                        PopupMenuItem(
                          onTap: ()  {
                            ...
                            strengthsController.deleteStrength(_result.id.toString(), context);
                          },
                          child:Row(
                            children: [
